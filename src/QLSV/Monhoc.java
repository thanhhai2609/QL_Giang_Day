...
public class Monhoc implements Serializable {
	...
	public Monhoc() {
		this(Monhoc.MONHOC_ID, Monhoc.MONHOC_NAME, Monhoc.MONHOC_PRICE, Monhoc.MONHOC_CREDITS);
	}
	
	public Monhoc(int monhoc_id, String monhoc_name, double monhoc_price, int monhoc_credits) {
