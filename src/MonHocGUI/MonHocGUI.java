...
public class MonHocGUI extends JFrame {
    ...
    private MonhocManagerDetail cmd = new MonhocManagerDetail();
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    frame.setTitle("QUẢN LÍ MÔN HỌC");
     ...
     */
    public MonHocGUI() throws IOException, ClassNotFoundException {
        textField.setToolTipText("");
        textField.setColumns(10);
        initTable();
        list = FileMonhoc.binaryInputFile("Monhoc.bin", FileMonhoc.countObject());
        fillTable(list);
        ...
        JLabel lblNewLabel = new JLabel("QUẢN LÍ MÔN HỌC");
        ...
        lblNewLabel_6 = new JLabel("NĂM HỌC");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (Major c : list) {
                    if (com.getMonhoc_name().compareTo(c.getMonhoc_name()) == 0) {
                        JOptionPane.showMessageDialog(contentPane, "Monhoc already exist!", "Error", JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                }
                cmd.addMonhoc(com);
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                textPrice.setText(MonHocGUI.formatString((String) table.getValueAt(row, 2)));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (value.compareTo("price") == 0) {
                    try {
                        ...
                        listSearch = cmd.searchMonhoc(price);
                    } catch (Exception e4) {
                    ...
                    try {
                        ...
                        listSearch = cmd.searchMonhocbyNamHoc(year);
                    } catch (Exception e5) {
        ...
        btnSort.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < creditsRow; i++) {
                    ...
                    com.setMonhoc_price(Double.parseDouble(MonHocGUI.formatString((String) table.getValueAt(i, 2))));
        ...
        //Set Icon
        URL ic = MonHocGUI.class.getResource("sinhvien.png");
        Image img = Toolkit.getDefaultToolkit().createImage(ic);
        this.setIconImage(img);
    }

    private void initTable() {
        String[] columns = {"ID", "Môn Học", "Giá", "Số Tín", "Ngành", "Năm học"};
    ...
    private void fillTable(List<Major> list) throws IOException, ClassNotFoundException {
        ...
        for (Major com : list) {
            tableModel.addRow(new String[]{
                ...
                "" + com.getMonhoc_credits(), com.getNameMJ(), String.format("%d", com.getYear())
            });
        }
    ...
    public boolean checkValidData() {
        ...
        try {
            ...
            if (year < 0) {
                sb.append("Năm học phải lớn hơn 0");
            }
        } catch (Exception e10) {
            sb.append("Năm học phải là số");
        }
        if (sb.length() > 0) {
